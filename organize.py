...
# rootPath = os.path.join(os.environ['USERPROFILE'], "Downloads")
# imagesPath = os.path.join(os.environ['USERPROFILE'], "Pictures")
# videosPath = os.path.join(os.environ['USERPROFILE'], "Videos")
# audiosPath = os.path.join(os.environ['USERPROFILE'], "Music")
# documentsPath = os.path.join(os.environ['USERPROFILE'], "Documents")
# applicationsPath = os.path.join(os.environ['USERPROFILE'], "Applications")
